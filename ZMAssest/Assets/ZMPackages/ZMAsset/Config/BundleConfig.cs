...
{
    /// <summary>
    ///  配置协议版本 2 首次加入带模块信息的 Bundle 依赖。
    ///  字段初始化器会让缺失该字段的旧 JSON 在部分反序列化器中得到 2，因此运行时还会检查 v2 载荷字段，不能只看版本号。
    /// </summary>
    public int formatVersion = 2;
    /// <summary>
    ///  当前配置所属模块，便于运行时在空配置和诊断场景中仍能确定所有者。
    /// </summary>
    public string moduleName;
    /// <summary>
    ///  当前模块依赖的其他资源模块；新运行时用它建立初始化顺序和租约图。
    /// </summary>
...
public class BundleInfo
{
    ...
    /// <summary>
    ///  协议版本 2 的完整 Bundle 依赖身份，跨模块依赖不再依赖“主资源模块目录”这一隐含假设。
    /// </summary>
    public List<BundleDependencyInfo> bundleDependencies;
}

/// <summary>
///  使用“模块 + Bundle 名称”描述一个物理 Bundle 依赖。
/// </summary>
[System.Serializable]
public class BundleDependencyInfo
{
    ...
    public string bundleModule;
    /// <summary>
    ///  依赖 Bundle 的文件名，包含框架配置的 AssetBundle 后缀。
    /// </summary>
    public string bundleName;
}
/// <summary>
